...
var fightOrSkip = function() {
  //ask player if they'd like to fight or skip using this fxn
  var promptFight = window.prompt('Would you like to FIGHT or SKIP this battle? Enter "FIGHT" or "SKIP" to choose.')
  // Conditional Recursive Function Call
  //if the `promptFight` is not a valid value, then execute the following statement in alert
  ...
  if (promptFight === "skip") /* or if(!promptFight) */ {
...
var startGame = function() {
  ...
  var endGame = function() {
    ...
    if (playerInfo.money > highScore) {
      ...
      localStorage.setItem("name", player.Info.name);
...
// player information
var playerInfo = {
    name: getPlayerName(), // don't need anymore: window.prompt("What is your robot's name?"),
    health: 100,
    attack: 10,
    money: 10,
    reset: function() {
